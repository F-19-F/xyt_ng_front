<template>
	<view>
		...
		<view class="cu-list menu sm-border">
			<view class="cu-item">
				<view class="content">
					<button class="cu-btn bg-orange-1 shadow" @click="modalName = 'WeekModal'">
						第{{ thisWeek }}周
					</button>
				</view>
				<view class="action">
			...
			<view class="cu-item">
				...
				<view class="action">
					<button class="cu-btn bg-orange-1 shadow" @click="modalName = 'JcModal'">
						第{{ jcText }}大节
					</button>
				</view>
			</view>
		...
		<view class="cu-modal bottom-modal" :class="modalName == 'LocalModal' ? 'show' : ''">
			<view class="cu-dialog">
				...
				<view class="grid col-3 padding-sm bg-gray">
					<view v-for="(item, index) in scBuildings" class="padding-xs" :key="index">
						<button class="cu-btn blue block" :class="index + 1 == thisLocal ? 'bg-blue' : 'line-blue'"
							@click="
                thisLocal = item.id;
			...
			<view class="cu-dialog">
				...
				<view class="grid col-3 padding-sm bg-gray">
					<view v-for="(item, index) in jc" class="padding-xs" :key="index">
						<button class="cu-btn blue lg block" :class="item.checked ? 'bg-blue' : 'line-blue'"
